...
namespace NintendoSpy
{
    public class InputSource
    {
        ...
        static public readonly InputSource SEGA = new InputSource("sega", "Sega/Atari", true, false, port => new SerialControllerReader(port, Sega.ReadFromPacket));


        static public readonly IReadOnlyList <InputSource> ALL = new List <InputSource> {
            NES, SNES, N64, GAMECUBE, PC360, PAD, PADATOD, SEGA
        };
