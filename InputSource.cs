...
namespace RetroSpy
{
    public class InputSource
    {
        ...
        static public readonly InputSource JAGUAR = new InputSource("jaguar", "Atari Jaguar", true, false, false, port => new SerialControllerReader(port, SuperNESandNES.ReadFromPacket_Jaguar));
