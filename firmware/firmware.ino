...
void read_IntellivisionData()
{
    ...
    intRawData |= PIN_READ(2) == 0 ? 0x080 : 0x00;
    intRawData |= PIN_READ(3) == 0 ? 0x040 : 0x00;
    intRawData |= PIN_READ(4) == 0 ? 0x020 : 0x00;
    intRawData |= PIN_READ(5) == 0 ? 0x010 : 0x00;
    intRawData |= PIN_READ(7) == 0 ? 0x008 : 0x00;
    intRawData |= PINB_READ(2) == 0 ? 0x004 : 0x00;
    intRawData |= PINB_READ(3) == 0 ? 0x002 : 0x00;
    intRawData |= PINB_READ(0) == 0 ? 0x001 : 0x00;
}

void sendIntellivisionData()
{
